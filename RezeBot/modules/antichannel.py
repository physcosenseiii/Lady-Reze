...
from RezeBot.modules.helper_funcs.decorators import rezecmd, rezemsg
from RezeBot.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from RezeBot.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel
from RezeBot.modules.language import gs

@rezecmd(command="antichannelmode", group=100)
...
@rezemsg(Filters.chat_type.groups, group=110)
