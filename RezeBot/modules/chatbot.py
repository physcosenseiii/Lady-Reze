...
import html
import requests
import RezeBot.modules.sql.chatbot_sql as sql
...
from RezeBot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from RezeBot import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Reze Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Reze Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Reze Ai Enabled Chats</b>\n"
    for chat in chats:
        try:
