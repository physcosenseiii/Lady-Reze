...
import RezeBot.modules.sql.global_bans_sql as sql
from RezeBot.modules.sql.users_sql import get_user_com_chats
from RezeBot import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from RezeBot.modules.helper_funcs.misc import send_to_list
