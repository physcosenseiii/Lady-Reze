...
class Config(object):
    ...
    #RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "postgressql://ovmujxzt:fR8weVTb_O7FCtdsA4_ytkqV0MsWx-Hk@ella.db.elephantsql.com/ovmujxzt" # needed for any database modules
    REDIS_URI = " "
    LOAD = []
    ...
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "3pCvmSxKSdV8spNpoAt_V_eoaIEfSzI3cw"  # go to support.spamwat.ch to get key
